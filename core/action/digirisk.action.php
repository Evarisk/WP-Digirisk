...
class Digirisk_Action {
	...
	public function callback_admin_menu() {
		...
		if ( ! empty( $digirisk_core['installed'] ) ) {
			add_menu_page( __( 'DigiRisk', 'digirisk' ), __( 'DigiRisk', 'digirisk' ), 'manage_digirisk', 'digirisk-simple-risk-evaluation', array( Digirisk_Class::g(), 'display' ), PLUGIN_DIGIRISK_URL . 'core/assets/images/favicon.png', 4 );
		}
	}
