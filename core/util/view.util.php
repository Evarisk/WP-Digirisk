...
class View_util extends Singleton_util {
	 ...
	 * @param  boolean $filter                Est ce qu'on utilise apply_fiters pour cette vue ou pas.
	 * @return void                        	 nothing
	 */
	public static function exec( $module_name, $view_path_without_ext, $args = array(), $filter = true ) {
