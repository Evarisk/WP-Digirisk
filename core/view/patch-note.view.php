...
<div class="notification patch-note active">
	...
	<span class="title">Note de mise à jour de la <a href="#">version <?php echo esc_attr( \eoxia\Config_Util::$init['digirisk']->major_version ); ?></a></span>
	<span class="close action-attribute"
				...
				data-version="<?php echo esc_attr( \eoxia\Config_Util::$init['digirisk']->major_version ); ?>"><i class="icon fa fa-times-circle"></i></span>
</div>
