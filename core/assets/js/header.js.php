<script type="text/javascript" >
	...
	var digi_confirm_delete = "<?php _e( 'Confirm delete ?', 'wpdigi-i18n' ); ?>";

	var digi_tools_in_progress = "<?php _e( 'En cours...', 'wpdigi-i18n'); ?>";
	var digi_tools_done = "<?php _e( 'Terminé', 'wpdigi-i18n'); ?>";
	var digi_tools_confirm = "<?php _e( 'Attention, avant cette opération, il est recommendé de faire une sauvegarde de votre base de donnée.', 'wpdigi-i18n' ); ?>"
</script>
