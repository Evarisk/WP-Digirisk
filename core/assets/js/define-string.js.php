<script type="text/javascript" >
	...
	var digi_confirm_delete = "<?php _e( 'Confirm delete ?', 'digirisk' ); ?>";

	var digi_tools_in_progress = "<?php _e( 'En cours...', 'digirisk'); ?>";
	var digi_tools_done = "<?php _e( 'Terminé', 'digirisk'); ?>";
	var digi_tools_confirm = "<?php _e( 'Attention, avant cette opération, il est recommendé de faire une sauvegarde de votre base de donnée.', 'digirisk' ); ?>"
</script>
