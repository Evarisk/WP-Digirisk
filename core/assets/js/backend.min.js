...
window.digirisk.loader = function() {
	window.digirisk.loader.init();
}

window.digirisk.loader.init = function() {};

window.digirisk.popup = function() {
	window.digirisk.popup.init();
...
window.digirisk.evaluation_method_evarisk = function() {
	window.digirisk.evaluation_method_evarisk.init();
