...
<?php
	if ( !empty( $group_list ) ) : /**	Si il y a des groupements / If there are group existing	*/
		$unique_identifier = $this->get_unique_identifier_in_list_by_id( $default_selected_group_id, $group_list );
		$title = $this->get_title_in_list_by_id( $default_selected_group_id, $group_list );
