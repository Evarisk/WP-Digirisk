<?php if ( !defined( 'ABSPATH' ) ) exit; ?>
	<li class="<?php echo $workunit->id == $args['workunit_id'] ? 'active' : ''; ?> wp-digi-list-item wp-digi-workunit-<?php echo $workunit->id; ?> wp-digi-item-workunit" data-id="<?php echo $workunit->id; ?>" data-type="<?php echo $this->post_type; ?>" data-nonce="<?php echo $workunit_display_nonce; ?>" >
