...
<form method="post" class="wp-digi-form" id="wpdigi-save-element-form" action="<?php echo admin_url( 'admin-ajax.php' ); ?>" >
	...
	<div class="gridwrapper4">
		...
		<div class="form-element"><label><?php _e( 'Start audit date', 'digirisk' ); ?><input type="text" class="eva-date" value="<?php echo mysql2date( 'd/m/Y', current_time( 'mysql', 0 ), true ); ?>" name="dateDebutAudit" /></label></div>
		<div class="form-element"><label><?php _e( 'End audit date', 'digirisk' ); ?><input type="text" class="eva-date" value="<?php echo mysql2date( 'd/m/Y', current_time( 'mysql', 0 ), true ); ?>" name="dateFinAudit" /></label></div>
