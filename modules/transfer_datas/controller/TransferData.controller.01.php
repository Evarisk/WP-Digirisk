...
// 		TABLE_TACHE,
	...
	*/
	function admin_menu() {
		...
		$digi_data_transfer_menu = add_menu_page( __( 'Digirisk : Manage datas transfert from digirisk V5.X', 'digirisk' ), __( 'Digirisk', 'digirisk' ), 'manage_options', 'digi-transfert', array( &$this, 'transfer_page' ), WPDIGI_URL . 'core/assets/images/favicon.png', 4 );
	}
