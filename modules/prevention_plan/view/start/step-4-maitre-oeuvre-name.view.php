	...
	<?php endif; ?>
		...
		<?php if( ! empty( $prevention->data[ 'maitre_oeuvre' ][ 'data' ]->last_name ) ): ?>
			<label class="form-field-container">
				...
				<input type="text" class="form-field" name="maitre-oeuvre-name" value="<?php echo esc_attr( $prevention->data[ 'maitre_oeuvre' ][ 'data' ]->last_name ); ?>">
			</label>
		<?php else: ?>
		...
		<span class="form-label"><?php esc_html_e( 'Prénom', 'digirisk' ); ?></span>
			<label class="form-field-container">
				...
				<?php if( ! empty( $prevention->data[ 'maitre_oeuvre' ][ 'data' ]->first_name ) ): ?>
					<input type="text" class="form-field" name="maitre-oeuvre-lastname" value="<?php echo esc_attr( $prevention->data[ 'maitre_oeuvre' ][ 'data' ]->first_name ); ?>">
				<?php else: ?>
