...
<section class="grid-layout w2">
	...
	<div>
		...
		<?php \eoxia\View_Util::exec( 'digirisk', 'evaluator', 'list-evaluator-affected', array( 'element' => $element, 'element_id' => $element->id, 'current_page' => $current_page, 'number_page' => $number_page, 'list_affected_evaluator' => $list_affected_evaluator ) ); ?>
	</div>
	...
	<div>
		...
		<?php \eoxia\View_Util::exec( 'digirisk', 'evaluator', 'list-evaluator-to-assign', array( 'element' => $element, 'element_id' => $element->id, 'current_page' => $current_page, 'number_page' => $number_page, 'evaluators' => $evaluators ) ); ?>
	</div>
</section>
