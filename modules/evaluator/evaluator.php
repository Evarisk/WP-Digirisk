...
include( WPDIGI_EVALUATOR_PATH . '/model/evaluator.model.01.php' );

/**     Instanciation du module / Instanciate module    */
include( WPDIGI_EVALUATOR_PATH . '/controller/evaluator.controller.01.php' );
include( WPDIGI_EVALUATOR_PATH . '/controller/evaluator.action.01.php' );
