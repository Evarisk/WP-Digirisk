...
<section class="gridwrapper2">
	...
	<div>
		<?php do_shortcode( '[digi-search id="' . $element->id . '" next-action="display_evaluator_affected" type="user" target="wp-digi-list-evaluator"]' ); ?>
	...
	<div>
		<?php do_shortcode( '[digi-search id="' . $element->id . '" next-action="display_evaluator_to_assign" type="user" target="wp-form-evaluator-to-assign"]' ); ?>
