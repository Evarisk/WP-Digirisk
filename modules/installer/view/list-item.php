...
<li class="wp-digi-list-item" data-id="<?php echo $user->id; ?>">
	...
	<span class="wp-digi-user wp-digi-user-action">
		<a href="#" data-id="<?php echo $user->id; ?>" data-nonce="<?php echo wp_create_nonce( 'ajax_installer_load_user_' . $user->id ); ?>" class="wp-digi-action wp-digi-action-load dashicons dashicons-edit"></a>
		<a href="#" data-id="<?php echo $user->id; ?>" data-nonce="<?php echo wp_create_nonce( 'ajax_installer_delete_user_' . $user->id ); ?>" class="wp-digi-action wp-digi-action-delete dashicons dashicons-no-alt"></a>
	</span>
</li>
