...
class installer_class {
	...
	public function admin_menu() {
		...
		if ( empty( $digirisk_core['installed'] ) && ( empty( $old_eva_option ) || ( $old_eva_option < 0 ) ) ) {
			add_menu_page( __( 'Digirisk installer', 'digirisk' ), __( 'Digirisk', 'digirisk' ), 'manage_options', 'digi-setup', array( $this, 'setup_page' ), PLUGIN_DIGIRISK_URL . 'core/assets/images/favicon.png', 4 );
		}
	}
