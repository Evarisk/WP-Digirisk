 ...
 * Classe gérant les utilisateurs dans la page "utilisateur" de WordPress.
 */
class User_Dashboard_Class extends \eoxia001\Singleton_Util {
	...
	public function display_list_user() {
		...
		\eoxia001\View_Util::exec( 'digirisk', 'user_dashboard', 'list', array( 'list_user' => $list_user, 'user_schema' => $user_schema ) );
	}
}
