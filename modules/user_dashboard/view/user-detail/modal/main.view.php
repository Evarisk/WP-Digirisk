		...
		if ( ! empty( $affected_groups ) ) :
			foreach ( $affected_groups as $affected_group ) :
				...
				<tr>
					...
					<td data-title="Nom"><a target="_blank" href="<?php echo admin_url( 'admin.php?page=digirisk-du&society_id=' . $affected_group->data['id'] ); ?>"><?php echo $affected_group->data['title']; ?></a></td>
				</tr>
				<?php
			endforeach;
		else :
