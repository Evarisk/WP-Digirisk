...
<div class="digirisk-wrap user-dashboard">
	...
	<div class="form email-domain">
		...
		<span data-parent="form" data-namespace="digirisk" data-module="userDashboard" data-before-method="checkDomainEmailValid" class="w40 action-input float right button green"><i class="fas fa-save" aria-hidden="true"></i></span>
	</div>
