...
<li class="wp-digi-risk-item wp-digi-list-item" data-id="<?php echo $user->id; ?>">
	...
	<span><a href="#" data-id="<?php echo $user->id; ?>" data-nonce="<?php echo wp_create_nonce( 'ajax_view_user_detail_' . $user->id ); ?>" class="wp-digi-action wp-digi-action-view-detail dashicons dashicons-visibility"></a></span>
