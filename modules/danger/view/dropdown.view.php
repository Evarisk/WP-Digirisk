...
<div class="danger categorie-container toggle grid padding tooltip red"
			...
			aria-label="<?php esc_html_e( 'Vous devez choisir un risque.', 'digirisk' ); ?>">

	<div class="action">
		<span class="<?php echo ! empty( $preset ) && ! empty( $selected_danger ) ? 'hidden' : ''; ?>"><?php esc_html_e( 'Choisir un risque', 'digirisk' ); ?></span>
