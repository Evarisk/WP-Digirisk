		...
		<div class="content">
			...
			<table class="table-evaluation">
				<thead>
					<tr>
						<td></td>
						<?php \eoxia001\View_Util::exec( 'digirisk', 'evaluation_method', 'popup/header', array( 'risk' => $risk, 'list_evaluation_method_variable' => $list_evaluation_method_variable ) ); ?>
					</tr>
				</thead>
				<tbody>
					<?php
					...
					for ( $i = 0; $i < $number_variables; $i++ ) :
						\eoxia001\View_Util::exec( 'digirisk', 'evaluation_method', 'popup/row', array( 'current_var_index' => $i, 'risk' => $risk, 'list_evaluation_method_variable' => $list_evaluation_method_variable, 'number_variables' => $number_variables ) );
					endfor; ?>
				</tbody>
			</table>
