...
<tr class="user-row">
	...
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_du' ) ) ? 'checked' : ''; ?>
	...
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_accident' ) ) ? 'checked' : ''; ?>
			name="users[<?php echo esc_attr( $user->data['id'] ); ?>][capability][manage_accident]"
			id="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>" type="checkbox" />
				<label for="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>"></label>
	</td>
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_causerie' ) ) ? 'checked' : ''; ?>
			name="users[<?php echo esc_attr( $user->data['id'] ); ?>][capability][manage_causerie]"
			id="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>" type="checkbox" />
				<label for="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>"></label>
	</td>
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_prevention' ) ) ? 'checked' : ''; ?>
			name="users[<?php echo esc_attr( $user->data['id'] ); ?>][capability][manage_prevention]"
			id="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>" type="checkbox" />
				<label for="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>"></label>
	</td>
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_permis_feu' ) ) ? 'checked' : ''; ?>
			name="users[<?php echo esc_attr( $user->data['id'] ); ?>][capability][manage_permis_feu]"
			id="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>" type="checkbox" />
				<label for="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>"></label>
	</td>
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_listing_risque' ) ) ? 'checked' : ''; ?>
			name="users[<?php echo esc_attr( $user->data['id'] ); ?>][capability][manage_listing_risque]"
			id="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>" type="checkbox" />
				<label for="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>"></label>
	</td>
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_sorter' ) ) ? 'checked' : ''; ?>
			name="users[<?php echo esc_attr( $user->data['id'] ); ?>][capability][manage_sorter]"
			id="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>" type="checkbox" />
				<label for="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>"></label>
	</td>
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_users' ) ) ? 'checked' : ''; ?>
			name="users[<?php echo esc_attr( $user->data['id'] ); ?>][capability][manage_users]"
			id="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>" type="checkbox" />
				<label for="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>"></label>
	</td>
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_tools' ) ) ? 'checked' : ''; ?>
			name="users[<?php echo esc_attr( $user->data['id'] ); ?>][capability][manage_tools]"
			id="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>" type="checkbox" />
				<label for="have_capability_<?php echo esc_attr( $user->data['id'] ); ?>"></label>
	</td>
	<td>
		<input <?php echo ( $has_capacity_in_role ) ? 'disabled' : ''; ?> <?php echo ( $user->data['wordpress_user']->has_cap( 'manage_setting' ) ) ? 'checked' : ''; ?>
