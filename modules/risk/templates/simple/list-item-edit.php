...
?>
	<form method="post" action="<?php echo admin_url( 'admin-ajax.php' ); ?>" class="wp-digi-table-item-edit wp-digi-list-item wp-digi-risk-item" data-risk-id="<?php echo $risk_id; ?>">
		...
		<span title="<?php _e( 'Upload media', 'digirisk' ); ?>" class="wp-digi-element-thumbnail wp-digi-risk-thumbnail wpeo-upload-media" data-type="digi-risk" data-id="<?php echo $risk_id; ?>" >
			<div class="mask">
			...
			<?php else: ?>
				<i title="<?php _e( 'Upload image', 'digirisk' ); ?>" class="wp-digi-element-thumbnail wp-digi-risk-thumbnail dashicons dashicons-format-image" data-type="digi-risk" data-id="<?php echo $risk_id; ?>" ></i>
			<?php endif; ?>
		</span>
