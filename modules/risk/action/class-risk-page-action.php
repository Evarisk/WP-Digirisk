...
class Risk_Page_Action {
	...
	public function callback_admin_menu() {
		$hook = add_submenu_page( 'digirisk-simple-risk-evaluation', __( 'Listing de risque', 'digirisk' ), __( 'Risques', 'digirisk' ), 'manage_listing_risque', 'digirisk-handle-risk', array( Risk_Page_Class::g(), 'display' ), PLUGIN_DIGIRISK_URL . 'core/assets/images/favicon2.png', 4 );
