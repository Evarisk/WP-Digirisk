...
?>
	<li class="wp-digi-list-item wp-digi-risk-item" data-risk-id="<?php echo $risk->id; ?>" >
		...
		<?php add_thickbox(); ?>
		<a href="<?php echo admin_url( 'admin-ajax.php?action=open_task&id=' . $risk->id ); ?>" class="thickbox" title="Gestion des tâches correctives pour le risque : <?php echo $risk->unique_identifier; ?> - <?php echo $risk->evaluation[0]->unique_identifier; ?>" >Task</a>
