...
if ( ! empty( $groupments ) ) :
	foreach ( $groupments as $groupment ) :
		...
		<li id="menu-item-<?php echo esc_attr( $groupment->id ); ?>" data-drop="<?php echo ! empty( $groupment->list_workunit ) ? false : true; ?>" data-depth="<?php echo esc_attr( $i - 1 ); ?>" class="<?php echo ! empty( $groupment->list_workunit ) ? 'no-drop' : ''; ?> menu-item-depth-<?php echo esc_attr( $i - 1 ); ?>">
			...
			<input type="text" class="menu-item-data-parent-id" name="menu_item_parent_id[<?php echo esc_attr( $groupment->id ); ?>]" value="<?php echo esc_attr( $groupment->parent_id ); ?>" />
			<input type="text" class="menu-item-data-db-id" name="menu_item_db_id[<?php echo esc_attr( $groupment->id ); ?>]" value="<?php echo esc_attr( $groupment->id ); ?>" />
