...
class Accident_Travail_Benin_Class extends \eoxia\Post_Class {
	...
	public function generate() {
		...
		$document_creation_response = document_class::g()->create_document( '', array( 'accident_benin' ), $sheet_details );
	...
	public function set_accidents() {
		...
		$accident_details = array(
			'accidentDebut' => array( 'type' => 'segment', 'value' => array() ),
			'accidentFin' => array( 'type' => 'segment', 'value' => array() ),
		);
