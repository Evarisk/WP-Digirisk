...
<tr class="accident-row edit" data-id="<?php echo esc_attr( $accident->id ); ?>">
	...
	<td class="form-element <?php echo ! empty( $accident->location_of_lesions ) ? 'active' : ''; ?>">
		<input type="text" name="accident[location_of_lesions]" value="<?php echo esc_attr( $accident->location_of_lesions ); ?>">
		<span class="bar"></span>
	</td>

	<td class="form-element <?php echo ! empty( $accident->nature_of_lesions ) ? 'active' : ''; ?>">
		<input type="text" name="accident[nature_of_lesions]" value="<?php echo esc_attr( $accident->nature_of_lesions ); ?>">
		<span class="bar"></span>
	</td>

	<td class="form-element <?php echo ! empty( $accident->name_and_address_of_witnesses ) ? 'active' : ''; ?>">
		<textarea name="accident[name_and_address_of_witnesses]"><?php echo $accident->name_and_address_of_witnesses; ?></textarea>
		<span class="bar"></span>
	</td>

	<td class="form-element <?php echo ! empty( $accident->name_and_address_of_third_parties_involved ) ? 'active' : ''; ?>">
	...
	<td class="form-element <?php echo ! empty( $accident->observation ) ? 'active' : ''; ?>">
