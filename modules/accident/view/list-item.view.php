...
<div class="table-row-advanced">
	<div class="table-row">
		...
		<div data-title="<?php esc_attr_e( 'circumstances', 'digirisk' ); ?>" class="table-cell"><?php do_shortcode( '[digi_comment id="' . $accident->data['id'] . '" namespace="eoxia" type="comment" display="view" display_date="false" display_user="false"]' ); ?></div>
