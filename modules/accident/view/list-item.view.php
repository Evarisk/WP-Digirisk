...
<div class="col">
	...
	<div data-title="<?php esc_attr_e( 'Date et heure', 'digirisk' ); ?>" class="cell padding w150"><i class="icon far fa-calendar-alt"></i> <?php echo esc_html( $accident->accident_date['rendered']['date'] ); ?></div>
		...
		<div class="action grid-layout w3">
			...
			<?php else : ?>
				<span class="button grey h50 tooltip hover red" aria-label="<?php echo esc_attr_e( 'Corrompu', 'digirisk' ); ?>" href="">
					<i class="far fa-file-times icon" aria-hidden="true"></i>
				</span>
			<?php endif; ?>
			<div class="button light w50 edit action-attribute"
				...
				data-id="<?php echo esc_attr( $accident->id ); ?>"><i class="icon fas fa-pencil"></i></div>
			<div class="button light w50 delete action-delete"
				...
				data-message-delete="<?php esc_attr_e( 'Supprimer cet accident', 'digirisk' ); ?>"><i class="icon far fa-times"></i></div>
		</div>
	</div>
</div>
