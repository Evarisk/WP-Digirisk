...
<form action="<?php echo esc_attr( admin_url( 'admin-ajax.php' ) ); ?>" class="form" method="post">
	...
	<button class="wpeo-button button-main button-margin alignright action-input" data-parent="form"><i class="button-icon far fa-sync-alt"></i><span><?php esc_html_e( 'Générer les affichages légaux A3 et A4', 'digirisk' ); ?></span></button>
</form>
