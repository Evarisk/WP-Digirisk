...
<ul class="wp-digi-table">
  ...
  <li class="wp-digi-list-item">
    ...
    <span><input type="text" name="working_hour[thursday_morning]" value="<?php echo $data['legal_display']->option['working_hour']['thursday_morning']; ?>" /></span>
    <span><input type="text" name="working_hour[friday_morning]" value="<?php echo $data['legal_display']->option['working_hour']['friday_morning']; ?>" /></span>
    <span><input type="text" name="working_hour[saturday_morning]" value="<?php echo $data['legal_display']->option['working_hour']['saturday_morning']; ?>" /></span>
    <span><input type="text" name="working_hour[sunday_morning]" value="<?php echo $data['legal_display']->option['working_hour']['sunday_morning']; ?>" /></span>
  </li>
  ...
  <li class="wp-digi-list-item">
    ...
    <span><input type="text" name="working_hour[thursday_afternoon]" value="<?php echo $data['legal_display']->option['working_hour']['thursday_afternoon']; ?>" /></span>
    <span><input type="text" name="working_hour[friday_afternoon]" value="<?php echo $data['legal_display']->option['working_hour']['friday_afternoon']; ?>" /></span>
    <span><input type="text" name="working_hour[saturday_afternoon]" value="<?php echo $data['legal_display']->option['working_hour']['saturday_afternoon']; ?>" /></span>
    <span><input type="text" name="working_hour[sunday_afternoon]" value="<?php echo $data['legal_display']->option['working_hour']['sunday_afternoon']; ?>" /></span>
  </li>
