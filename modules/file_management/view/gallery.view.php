...
<div data-id="<?php echo $element_id; ?>" class="wpeo-gallery" style="display: none!important;">
  ...
  <ul class="action">
    ...
    <li><a href="#" data-nonce="<?php echo wp_create_nonce( 'associate_file' ); ?>" data-id="<?php echo $element_id; ?>" data-object-name="<?php echo $param['object_name']; ?>" class="wp-digi-bton-first wpeo-upload-media" ><i></i><?php _e( 'Add a new picture', 'digirisk' ); ?></a></li>
  </ul>
