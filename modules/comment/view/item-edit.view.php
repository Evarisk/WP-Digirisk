...
<li>
	...
	<input type="text" class="wpdigi_date" name="<?php echo $type; ?>[<?php echo $element->id ?>][list_comment][0][date]" value="<?php echo $comment->date; ?>" /> :
	<input type="text" class="wpdigi_comment" name="<?php echo $type; ?>[<?php echo $element->id ?>][list_comment][0][content]" value="<?php echo $comment->content; ?>" />
</li>
