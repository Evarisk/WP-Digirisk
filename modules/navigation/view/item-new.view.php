...
<div class="workunit-add tooltip red" aria-label="Le nom de l'unité de travail est obligatoire.">
	...
	<div class="add button disable w50 action-input" data-module="navigation" data-before-method="beforeSaveWorkunit" data-loader="workunit-add" data-parent="workunit-add"><i class="icon fa fa-plus"></i></div>
</div>
